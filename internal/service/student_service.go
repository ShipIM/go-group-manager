...
func (s *StudentService) GetStudents(name, surname, patronymic, groupName string, age int) ([]entity.Student, error) {
	return s.studentRepository.FindAllStudents(name, surname, patronymic, groupName, age)
}
